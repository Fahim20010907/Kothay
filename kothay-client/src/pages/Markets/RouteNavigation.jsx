...
const RouteNavigation = ({ marketName, marketLocation, marketCoordinates }) => {
                    ...
                    <div className="bg-teal-50 rounded-lg p-3 mb-3 border border-teal-200">
                        <div className="grid grid-cols-2 gap-4 text-center">
                            <div>
                                ...
                                <p className="text-lg font-bold text-teal-700">{distance?.toFixed(1)} km</p>
                            </div>
                            <div>
                                <p className="text-xs text-teal-600 flex items-center justify-center gap-1">
